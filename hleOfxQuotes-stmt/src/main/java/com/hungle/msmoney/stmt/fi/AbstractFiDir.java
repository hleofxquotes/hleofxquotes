...
public abstract class AbstractFiDir {
    ...
    public void checkRespFile(File respFile) throws IOException {
        com.hungle.msmoney.stmt.fi.props.OFX ofx = PropertiesUtils.getOfx(velocityContext);
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    protected void checkRespFile(File respFile, com.hungle.msmoney.stmt.fi.props.OFX ofx) throws IOException {
