...
import com.hungle.msmoney.stmt.fi.model.AccountGroup;
...
public class FinancialInstitutionDialog extends JDialog {
    ...
    /** The m phone group. */
    private final com.hungle.msmoney.stmt.fi.model.AccountGroup m_phoneGroup;
     ...
     */
    public FinancialInstitutionDialog(List<String> names, com.hungle.msmoney.stmt.fi.model.AccountGroup phoneGroup) {
        m_names = names;
